...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func headerBannerImage(size: NSSize) -> NSImage {
        // Load from the app's own Resources via Bundle.main. Do NOT use Bundle.module:
        // its SwiftPM-generated accessor *traps* (fatalError) when the resource bundle
        // isn't found, which crashes the app on any machine other than the build host.
